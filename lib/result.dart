...
class Result extends StatefulWidget {
  Result({Key? key, this.name}) : super(key: key);
  final name;
...
class _ResultState extends State<Result> {
            ...
            child: FutureBuilder(
                ...
                builder: (context, AsyncSnapshot snapshot) {
                  ...
                  return Column(children: [
                    Text(snapshot.data['naver']['rating']),
                    Text(snapshot.data['kakao']['rating']),
                    Text(snapshot.data['google']['rating'])
                  ]);
                })));
  }
  ...
  //   ratings = await searchAll(widget.name);
  //   setState(() {
  //     naver = ratings['naver'];
  //     kakao = ratings['kakao'];
  ...
  Future<Map> getData() async {
    Map map = await searchAll(widget.name);
    return map;
  }
